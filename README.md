...
Las indicaciones solicitaron el uso de 2 clases + una clase Main, siendo estas:
EjerciciosStaticLNumeros.java > Esta es la clase que contiene 4 métodos estáticos que están más relacionados a los números.
EjerciciosStaticCadenas.java > En esta clase están los otros 6 métodos estáticos, los cuales están más ligados a cadenas.
